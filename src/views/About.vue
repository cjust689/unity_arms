        ...
        <div class="parallax-container valign-wrapper container">
            <div class="row">
                 <div class="col s12 container">
                  ...
                  <br>
                  <h5 class="white-text half-opacity">"Under no pretext should arms and ammunition be surrendered; any attempt to disarm the workers must be frustrated, by force if necessary.”<h5>-Marx</h5></h5>
                </div>
            </div>
        </div>
    </div>
